...
# -------------------------------------------------------------------------
# ninja for 5 Locations
# -------------------------------------------------------------------------
df1 = pd.read_csv('all9dot.csv') # Read Train Data set from csv file for 9locations
df2 = pd.read_csv('all9dot_2019.csv') # Read Test Data set from csv file 9 locations
df1_new = df1.iloc[:175320] # :175320 for 5 locations Train Data set
df2_new = df2[:43800] # :43800 for 5 locations locations Test Data set
